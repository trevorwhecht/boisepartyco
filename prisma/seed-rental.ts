...
const ITEMS: ItemSeed[] = [
  ...
  { sku: "DECO-PEACOCK",   slug: "peacock-chair",   name: "Peacock Chair",        blurb: "Statement peacock rattan chair.",         categorySlug: "decoration", subcategory: "Props",      flatPrice: 75,  qty: null, size: "60\" H",   capacity: "photo seat",     sortOrder: 4, spec: { kind: "decoration", decType: "Peacock Chair", heightIn: 60 } },
