...
export default async function TablesChairsPage({ searchParams }: { searchParams: Promise<{ from?: string; to?: string }> }) {
  ...
  const items = await prisma.item.findMany({
    where: { category: { slug: { in: ["chair", "table"] } }, isActive: true },
